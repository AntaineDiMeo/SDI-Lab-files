...
// in simulator we redefine to format for myutilityapp Developer console
...
{\
	NSString * exceptionName = [@"org.myutilityapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.myutilityapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImyutilityappNativeItemNone = -1, 
	UImyutilityappNativeItemSpinner = -2,
	UImyutilityappNativeItemProgressBar = -3,
	
	UImyutilityappNativeItemSlider = -4,
	UImyutilityappNativeItemSwitch = -5,
	UImyutilityappNativeItemMultiButton = -6,
	UImyutilityappNativeItemSegmented = -7,
	
	UImyutilityappNativeItemTextView = -8,
	UImyutilityappNativeItemTextField = -9,
	UImyutilityappNativeItemSearchBar = -10,
	
	UImyutilityappNativeItemPicker = -11,
	UImyutilityappNativeItemDatePicker = -12,
	
	UImyutilityappNativeItemInfoLight = -13,
	UImyutilityappNativeItemInfoDark = -14,
	
	UImyutilityappNativeItemDisclosure = -15,
	
	UImyutilityappNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all myutilityapp instances of
