...
@interface myutilityappObject : KrollCoverageObject {
#else
@interface myutilityappObject : KrollObject {
#endif
@private
...
extern NSString * myutilityapp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	myutilityappObject *_myutilityapp;
    KrollObject* console;
	BOOL shutdown;
