...
//@interface myutilityappObject : NSObject
//@end

@interface myutilityappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[myutilityappObject class]])
		{
			for (NSString *key in [[(myutilityappObject*)o modules] allKeys])
			{
