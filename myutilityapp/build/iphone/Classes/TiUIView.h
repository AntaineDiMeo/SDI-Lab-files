...
/**
 Base class for all myutilityapp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the myutilityapp view hierarchy (such as wrapped iOS UIViews) was touched.
