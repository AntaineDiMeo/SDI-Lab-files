...
//Rare exceptions to indicate a bug in the _myutilityapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for myutilityapp proxies.
 */
